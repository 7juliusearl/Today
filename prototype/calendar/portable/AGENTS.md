...
The coworker edition excludes Weekly Rhythm and Learn & Observe / personal plans, including their section choices. Leave legacy data/schedule.js and data/plan.js files intact during upgrades; they are not displayed in this edition.
...
Keep any personal customization within this project. Do not edit Today.app: it is a compiled signed bundle. No compiler is needed for HTML/CSS/JS changes. Native features/permissions require a source rebuild and macOS developer tools; explain that boundary if requested. Do not disable Gatekeeper, remove quarantine, change macOS permissions, or automate Allow buttons.
...
Validate JavaScript syntax and review edited selectors/IDs. Restart Today after layout edits. Back up files before extensive edits. Do not upload the folder or publish changes without the user's request.
